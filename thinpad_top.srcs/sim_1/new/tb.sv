...
parameter BASE_RAM_INIT_FILE = "D:/MIPS32CPU/thinpad_top/thinpad_top.srcs/sim_1/new/main.bin"; //BaseRAM初始化文件，请修改为实际的绝对路�?
parameter EXT_RAM_INIT_FILE = "D:/MIPS32CPU/thinpad_top/thinpad_top.srcs/sim_1/new/main.bin";    //ExtRAM初始化文件，请修改为实际的绝对路�?
